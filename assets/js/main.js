(function(window, document, $, undefined) {
    ...
    var MidvectorJs = {
        ...
        methods: function(e) {
            MidvectorJs.smothScroll();
            MidvectorJs.counterUpActivation();
            MidvectorJs.wowActivation();
            MidvectorJs.headerTopActivation();
            MidvectorJs.headerSticky();
            MidvectorJs.salActive();
            MidvectorJs.popupMobileMenu();
            MidvectorJs.popupDislikeSection();
            MidvectorJs.popupleftdashboard();
            MidvectorJs.popuprightdashboard();
            MidvectorJs.preloaderInit();
            MidvectorJs.showMoreBtn();
            MidvectorJs.slickSliderActivation();
            MidvectorJs.radialProgress();
            MidvectorJs.contactForm();
            MidvectorJs.menuCurrentLink();
            MidvectorJs.onePageNav();
            MidvectorJs.selectPicker();
        },
        ...
        preloaderInit: function() {
            MidvectorJs._window.on('load', function() {
...
function generateAutoReply() {
    ...
    return `Midvector: I'm a dynamic chat bot!`;
}
...
function sendMessage() {
    ...
    if (welcomeMessageIndex < welcomeMessages.length) {
        const welcomeMessageElement = createMessageWithReactions('Midvector', welcomeMessages[welcomeMessageIndex], 'ai-speech', 'assets/images/team/avater.png');
        appendMessage(welcomeMessageElement);
        welcomeMessageIndex++;
    } else {
        const autoReply = generateAutoReply();
        const autoReplyElement = createMessageWithReactions('Midvector', autoReply, 'ai-speech', 'assets/images/team/avater.png');
...
function saveAndRegenerateMessage(button) {
    ...
    const regeneratedMessageElement = createMessageWithReactions('Midvector', regeneratedMessage, 'ai-speech', 'assets/images/team/avater.png');
